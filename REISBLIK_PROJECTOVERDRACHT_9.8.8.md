# REISBLIK — PROJECTOVERDRACHT 9.8.8

## Stand per 14 september 2026

De actuele ontwikkelversie is **Reisblik 9.8.8**.
...
### 3. HTML per dag
`📚 HTML per dag` maakt voor iedere kalenderdag binnen de gekozen periode een afzonderlijk Japan-stijl HTML-bestand.

Voorbeeld:

- Datum van: 1 augustus 2026
- Datum t/m: 3 augustus 2026
- resultaat: 3 losse HTML-bestanden.

De bestandsnamen bevatten de datum en de eerste naam uit die dag.
...
- `sw.js`
- `CHANGELOG_9.8.8.md`
- `README_9.8.8_MASTER.md`
- `REISBLIK_PROJECTOVERDRACHT_9.8.8.md`
