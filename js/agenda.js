/* Reisblik 8.8.13 – Agenda: permanente agenda + handmatige JSON-import + ontdubbeling + archief */
(function(){
  ...
  async function importAgendaJson(){
    ...
    try{
      const response=await fetch(IMPORT_URL+'?v=8.8.13&t='+Date.now(),{cache:'no-store'});
