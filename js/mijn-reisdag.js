...
`;
  ...
  function japanSlideshowScript() {
    ...
    (function(){
        ...
        function bepaalFotoIndeling() {

            document.querySelectorAll(".slide-fotos").forEach(function(container) {
                ...
                if (fotos.length === 2) {
                    ...
                    console.log("Automatische indeling: 2 FOTO'S NAAST ELKAAR");
                ...
                if (fotos.length === 3 && aantalPortret === 3) {
                    ...
                    console.log("Automatische indeling: 3 PORTRETTEN NAAST ELKAAR");
                ...
                if (fotos.length === 3 && aantalPortret === 1 && aantalLandschap === 2) {

                    console.log("Automatische indeling: PORTRET LINKS + 2 LANDSCHAPPEN RECHTS");

                    container.style.gridTemplateColumns = "1fr 1fr";
                    container.style.gridTemplateRows = "1fr 1fr";

                    const portretIndex = fotos.findIndex(function(img) {
                        return img.naturalHeight > img.naturalWidth;
                    });

                    const landschapIndexes = fotos
                        .map(function(img, index) {
                            return img.naturalWidth > img.naturalHeight ? index : -1;
                        })
                ...
                if (fotos.length === 3 && aantalLandschap === 3) {
                    ...
                    console.log("Automatische indeling: 2 BOVEN + 1 GROOT ONDER");
                ...
                if (fotos.length === 4) {
                    ...
                    console.log("Automatische indeling: 2 X 2");
                ...
                /* -------------------------------------------------
                   Overige combinaties
                   Gebruik een nette eenvoudige rasterindeling.
                   ------------------------------------------------- */
