...
`;
  ...
  function japanSlideshowScript() {
    ...
    (function(){
        ...
        document.addEventListener('DOMContentLoaded',function(){
            document.querySelectorAll('dialog').forEach(function(d){if(d.querySelectorAll('.slide').length)show(d,0);});
        });
    })();
</script>`;
  }
  ...
  function japanDemoSlideshowHtml() {
    // Twee vaste voorbeeld-diavoorstellingen zoals in het oorspronkelijke Japan-HTML.
    // De echte foto's worden bewust NIET meegenomen: iedere plek is een FOTO-PLAATS.
    return `
<dialog id="ochtend-middag">
    <div id="slideshow1" class="slideshow-container">

        <div class="slide">
            <div class="text-slide"> overige foto's Hokoku-ji Tempel </div>
            <div class="japan-slide-foto-rij">
                <div class="japan-foto-plaats">PLAATS FOTO 1</div>
                <div class="japan-foto-plaats">PLAATS FOTO 2</div>
            </div>
            <div class="foto-onder">
        ...
        <div class="slide">
            <div class="foto-naast">
                <div class="japan-foto-plaats japan-slide-groot">PLAATS FOTO 5</div>
        ...
        <div class="slide">
            <div class="japan-foto-plaats japan-slide-breed">PLAATS FOTO 8</div>
        </div>

        <div class="slide">
            <div class="text-slide"> overige foto's Tsurugaoka Hachimangu Tempel </div>
            <div class="japan-foto-plaats japan-slide-breed">PLAATS FOTO 9</div>
            <div class="foto-onder">
                <div class="japan-foto-plaats japan-slide-breed">PLAATS FOTO 10</div>
            </div>
        </div>

        <div class="slide">
            <div class="japan-slide-foto-rij">
                <div class="japan-foto-plaats">PLAATS FOTO 11</div>
                <div class="japan-foto-plaats">PLAATS FOTO 12</div>
            </div>
            <div class="foto-onder">
                <div class="japan-foto-plaats">PLAATS FOTO 13</div>
                <div class="japan-foto-plaats">PLAATS FOTO 14</div>
            </div>
        </div>

        <div class="slide">
            <div class="foto-naast">
                <div class="japan-foto-plaats japan-slide-midden">PLAATS FOTO 15</div>
                <div class="rechter-kolom">
                    <div class="japan-foto-plaats">PLAATS FOTO 16</div>
                </div>
            </div>
        </div>

        <div class="slide">
            <div class="text-slide"> overige foto's Hase-dera Tempel </div>
            <div class="japan-slide-foto-rij">
                <div class="japan-foto-plaats">PLAATS FOTO 17</div>
                <div class="japan-foto-plaats">PLAATS FOTO 18</div>
            </div>
            <div class="foto-onder">
                <div class="japan-foto-plaats">PLAATS FOTO 19</div>
                <div class="japan-foto-plaats">PLAATS FOTO 20</div>
            </div>
            <div class="foto-onder">
                <div class="japan-foto-plaats">PLAATS FOTO 21</div>
                <div class="japan-foto-plaats">PLAATS FOTO 22</div>
            </div>
        </div>

        <div class="slide">
            <div class="foto-naast">
                <div class="japan-foto-plaats japan-slide-groot">PLAATS FOTO 23</div>
                <div class="rechter-kolom">
                    <div class="japan-foto-plaats">PLAATS FOTO 24</div>
                    <div class="japan-foto-plaats">PLAATS FOTO 25</div>
                </div>
            </div>
        </div>
...
<dialog id="middag-avond">
    <div id="slideshow2" class="slideshow-container">
        ...
        <div class="slide">
            <div class="text-slide"> overige foto's Grote Boeddha </div>
            <div class="japan-foto-plaats japan-slide-breed">PLAATS FOTO 26</div>
        </div>

        <div class="slide">
            <div class="foto-naast">
                <div class="japan-foto-plaats japan-slide-groot">PLAATS FOTO 27</div>
                <div class="rechter-kolom">
                    <div class="japan-foto-plaats">PLAATS FOTO 28</div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="foto-naast">
                <div class="japan-foto-plaats">PLAATS FOTO 29</div>
                <div class="japan-foto-plaats">PLAATS FOTO 30</div>
            </div>
        </div>

        <div class="slide">
            <div class="japan-foto-plaats japan-slide-breed">PLAATS FOTO 31</div>
            <div class="foto-onder">
                <div class="japan-foto-plaats">PLAATS FOTO 32</div>
                <div class="japan-foto-plaats">PLAATS FOTO 33</div>
                <div class="japan-foto-plaats">PLAATS FOTO 34</div>
            </div>
        </div>
