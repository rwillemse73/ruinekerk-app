...
(function(){
  ...
  function makeWordHtml(entries,selectedPeriod){
    const sections=entries.map((entry,index)=>{
      ...
      // Eigen foto's worden lokaal als data-URL opgeslagen. Neem die ook
      // daadwerkelijk mee in het Word-compatibele document.
      const ownPhoto=(item.userCreated && item.photo)
        ? '<div class="reisdag-photo"><img src="'+escapeHtml(item.photo)+'" alt="Foto '+escapeHtml(item.name||'locatie')+'"></div>'
        : '';
