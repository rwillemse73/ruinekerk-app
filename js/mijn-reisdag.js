...
(function(){
  ...
  function japanReplaceImages(root) {
    ...
    // Dit is belangrijk voor de Japan-opmaak: de fotoplaats moet exact op
    // dezelfde positie blijven staan als de oorspronkelijke foto.
    const images=[...root.querySelectorAll('img')];
    images.forEach(img=>{
      const placeholder=japanImagePlaceholder(img,n++);
  ...
  function japanAddStandardPhotoPlaces(block) {
  ...
  function japanNormalizeSlideshowDialog(dialog) {
    if(!dialog) return;

    const slides=[...dialog.querySelectorAll('.slide')];

    slides.forEach(slide=>{
      const photoPlaces=[...slide.querySelectorAll('.japan-foto-plaats')];
      ...
      slide.querySelectorAll('.foto-naast, .rechter-kolom, .foto-onder, .japan-slide-foto-rij').forEach(wrapper=>wrapper.remove());
      slide.querySelectorAll('.japan-foto-plaats').forEach(photo=>photo.remove());
  ...
  function japanPrepareLocationHtml(rawHtml,locationName,locationIndex) {
    ...
    try {
      ...
      dialogs.forEach((dialog,dialogIndex)=>{
        ...
        japanNormalizeSlideshowDialog(dialog);
      ...
      const replacedImageCount=japanReplaceImages(root);
...
.japan-slideshow-card {
    margin-top: 10px;
    text-align: center;
}
.japan-slideshow-card button {
    width: 100%;
    border: 0;
    padding: 0;
...
.japan-slide-foto-rij .japan-foto-plaats {
    flex: 1 1 0;
}
.japan-slide-groot {
    flex: 0 0 65%;
...
.slideshow-container .japan-foto-plaats {
    min-height: 110px;
    margin: 8px;
    border-radius: 15px;
}
.slideshow-container .rechter-kolom .japan-foto-plaats {
    margin: 0;
    min-height: 90px;
}
...
`;
  ...
  function japanSlideshowScript() {
    ...
    (function(){
        ...
        document.addEventListener('click',function(e){
            ...
            if(open){
                var d=document.getElementById(open.getAttribute('data-japan-open'));
                if(d){
                    d.showModal();
                    show(d,0);
                    bepaalFotoIndeling();
            ...
            if(close){
                document.getElementById(close.getAttribute('data-japan-close'))?.close();
                return;
            }

            var prev=e.target.closest('[data-japan-prev]');
            if(prev){
                var d=document.getElementById(prev.getAttribute('data-japan-prev'));
                if(d){
            ...
            if(next){
                var d=document.getElementById(next.getAttribute('data-japan-next'));
                if(d){
                    var s=[...d.querySelectorAll('.slide')];
                    var i=s.findIndex(x=>x.style.display!=='none');
                    show(d,(i<0?0:i)+1);
  ...
  function japanNavigationHtml() {
    return `    <div style="display: flex; justify-content: center; gap: 10px; flex-wrap: wrap; margin-top: 15px;">
        ...
        <a href="#" data-japan-page-link="previous"><button type="button">vorige Pagina</button></a>
        <a href="#" data-japan-page-link="next"><button type="button">Volgende Pagina</button></a>
    </div>`;
  }

  function japanDemoSlideshowHtml() {
...
<dialog id="ochtend-middag">
    <div id="slideshow1" class="slideshow-container">
        ...
        <div class="slide">
            ...
            <div class="text-slide">
                overige foto's Hokoku-ji Tempel
            </div>

            <div class="slide-fotos">

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 1</div>
                </div>

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 2</div>
                </div>

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 3</div>
                </div>
        ...
        <div class="slide">
            ...
            <div class="text-slide">
                overige foto's Tsurugaoka Hachimangu Tempel
            </div>

            <div class="slide-fotos">

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 4</div>
                </div>
    ...
    <!-- Knoppen -->
    <a class="prev" data-japan-prev="ochtend-middag">&#10094;</a>
    <a class="next" data-japan-next="ochtend-middag">&#10095;</a>
    <button class="close-btn" data-japan-close="ochtend-middag">Sluiten</button>
</dialog>
...
<dialog id="middag-avond">
    <div id="slideshow2" class="slideshow-container">
        ...
        <div class="slide">
            ...
            <div class="text-slide">
                overige foto's Grote Boeddha
            </div>

            <div class="slide-fotos">

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 5</div>
                </div>

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 6</div>
                </div>

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 7</div>
                </div>

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 8</div>
                </div>
        ...
        <div class="slide">
            ...
            <div class="text-slide">
                overige foto's Matsumoto-kasteel
            </div>

            <div class="slide-fotos">

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 9</div>
                </div>

                <div class="slide-foto">
                    <div class="japan-foto-plaats">PLAATS FOTO 10</div>
                </div>
    ...
    <!-- Knoppen -->
    <a class="prev" data-japan-prev="middag-avond">&#10094;</a>
    <a class="next" data-japan-next="middag-avond">&#10095;</a>
    <button class="close-btn" data-japan-close="middag-avond">Sluiten</button>
</dialog>`;
  }

  function japanSlideshowTriggerHtml(dialogId, title, fotoLabel) {
    return `
        <div class="omkaderde-tekst japan-slideshow-card">
            <button type="button" data-japan-open="${dialogId}">
                <span class="japan-foto-plaats japan-trigger-foto">${fotoLabel}</span>
            </button>
            <figcaption>
  ...
  async function makeJapanTravelHtml(entries,dateFrom,dateTo) {
    ...
    const columnHtml=(items,columnNumber)=>items.map(entry=>{
      const doc=new DOMParser().parseFromString('<div id="japanLocationBlock" class="tekst-normaal">'+entry.html+'</div>','text/html');
      const block=doc.getElementById('japanLocationBlock');
      japanAddStandardPhotoPlaces(block);
      // Ook bestaande, geneste tekstblokken uit een oorspronkelijke locatie-HTML
      // krijgen dezelfde twee standaard fotoplaatsen.
      block.querySelectorAll('.tekst-normaal').forEach(nested=>japanAddStandardPhotoPlaces(nested));
      return japanPrettyNode(block,1);
    }).join('\n')+
      (columnNumber===1 ? japanSlideshowTriggerHtml('ochtend-middag','Rest foto\'s Hokoku-ji, Tsurugaoka Hachimangu en Hase-dera','FOTO-PLAATS — slideshow ochtend/middag') : '')+
      (columnNumber===3 ? japanSlideshowTriggerHtml('middag-avond','Overige foto\'s van de middag en avond','FOTO-PLAATS — slideshow middag/avond') : '');
...
${topMap}
    <div class="japan-foto-plaats japan-foto-top">FOTO-PLAATS 2</div>
    <div class="japan-foto-plaats japan-foto-top">FOTO-PLAATS 3</div>
    <div class="japan-foto-plaats japan-foto-top">FOTO-PLAATS 4</div>
</div>
...
${japanSlideshowScript()}
  ...
  async function generateJapanTravelHtmlPerDay(dateFrom,dateTo){
    ...
    try{
      ...
      for(const date of dates){
        ...
        const html=await makeJapanTravelHtml(entries,date,date);
  ...
  function showResults(dateFrom,dateTo){
    ...
    japan.type='button';
    japan.textContent='📖 Maak-reis-HTML';
    ...
    perDay.onclick=()=>generateJapanTravelHtmlPerDay(dateFrom,dateTo);
