...
<figcaption>
    <span class="fotobalk-caption">Kaart en fotoplaatsen voor deze reisdag — foto 1 is de kaart uit Mijn reisdag.</span>
</figcaption>
...
<div class="voettekst">
    <div class="japan-nav">
        <button type="button" onclick="history.back()">Vorige pagina</button>
