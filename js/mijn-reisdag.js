...
(function(){
  ...
  function makeTravelDiaryHtml(entries,dateFrom,dateTo){
    ...
    return '<!DOCTYPE html><html lang="nl"><head><meta charset="utf-8">'+
      ...
      '<div class="dagboek-label">REISBLIK · EERSTE OPZET</div>'+
  ...
  function travelDiaryCss(){
    return `
      *{box-sizing:border-box}
      body{margin:0;background:#eeeae3;color:#26353a;font-family:Georgia,'Times New Roman',serif;line-height:1.55}
      .dagboek-pagina{width:min(1050px,100%);margin:0 auto;background:#fff;min-height:100vh;padding:44px 58px 60px}
      .dagboek-header{padding:18px 0 34px;border-bottom:1px solid #c9c3ba;margin-bottom:28px}
      .dagboek-label{font:700 12px/1.2 Arial,sans-serif;letter-spacing:2px;color:#6c777b;margin-bottom:16px}
      .dagboek-header h1{font-size:clamp(34px,5vw,62px);line-height:1.05;margin:0 0 12px;font-weight:700}
      .dagboek-datum{font:18px/1.4 Arial,sans-serif;color:#667176}
      .dagboek-datum span{white-space:nowrap}
      .dagboek-intro{font-size:18px;max-width:760px;margin:0 0 34px;color:#4d585c}
      .dagboek-locatie{break-inside:avoid;margin:0 0 48px;padding-top:8px}
      .dagboek-locatie-kop{display:flex;gap:18px;align-items:flex-start;margin-bottom:18px}
      .dagboek-nummer{font:700 13px/1 Arial,sans-serif;color:#8a9295;border-top:2px solid #26353a;padding-top:7px;min-width:34px}
      .dagboek-locatie-kop h2{font-size:30px;line-height:1.15;margin:0 0 5px}
      .dagboek-meta,.dagboek-adres{font:14px/1.45 Arial,sans-serif;color:#6c777b}
      .dagboek-adres{margin-top:2px}
      .dagboek-foto{margin:18px 0 26px}
      .dagboek-foto img{display:block;width:auto;max-width:100%;max-height:520px;height:auto;object-fit:contain}
      .dagboek-blok{margin:18px 0 0;max-width:850px}
      .dagboek-blok h3{font:700 12px/1.2 Arial,sans-serif;letter-spacing:1px;text-transform:uppercase;margin:0 0 8px;color:#526066}
      .dagboek-blok p{margin:0 0 12px;font-size:17px}
      .dagboek-blok ul{margin:0;padding-left:22px;font-size:16px}
      ...
      .dagboek-footer{margin-top:55px;padding-top:18px;border-top:1px solid #c9c3ba;color:#6c777b;font:13px/1.5 Arial,sans-serif}
      @media(max-width:700px){.dagboek-pagina{padding:28px 20px 45px}.dagboek-locatie-kop h2{font-size:25px}.dagboek-intro{font-size:16px}.dagboek-blok p{font-size:16px}}
      @media print{body{background:#fff}.dagboek-pagina{width:auto;padding:20mm 18mm;box-shadow:none}.dagboek-locatie{break-inside:avoid}}
    `;
  }
