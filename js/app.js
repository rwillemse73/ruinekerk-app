/* Reisblik 9.0.4 – Vakantiestructuur + vaste content */
let locations=[];
...
function getUserLocations(){
 try{return JSON.parse(localStorage.getItem(reisblikVakantieStorageKey('ruinekerk_user_locations_v1'))||'[]')}catch(e){return []}
}
function setUserLocations(items){
 localStorage.setItem(reisblikVakantieStorageKey('ruinekerk_user_locations_v1'),JSON.stringify(items));
}
