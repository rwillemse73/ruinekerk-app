# Reisblik 8.7.1 — technische schoonmaak

8.7.1 is een opruimversie op basis van de stabiele 8.6.9-referentie. Er is geen nieuwe gebruikersfunctionaliteit toegevoegd.
