/* Reisblik 9.8.19 — tijdelijke offline vakantie */
const CACHE_NAME = 'reisblik-app-v9.8.19';
...
const APP_SHELL = [
  ...
  './js/app.js?v=9.7.5','./js/ui.js?v=9.7.5','./js/backup.js?v=9.8.6',
  './js/clear-local-storage.js?v=9.7.5','./js/mijn-reisdag.js?v=9.8.19',
  './js/vakantie-archief.js?v=9.8.19',
  './js/restore.js?v=9.8.6','./js/search.js?v=9.7.5','./js/help.js?v=9.7.5',
