/* Reisblik 9.9.19 — betrouwbare actuele configuratie + cache-update */
const CACHE_NAME = 'reisblik-app-v9.9.19';
const OFFLINE_PREFIX = 'reisblik-offline-vacation-';
const APP_SHELL = [
  './','./index.html','./app.html','./manifest.json','./css/reisblik.css?v=9.9.19',
  './js/visited.js?v=9.9.19','./js/navigation.js?v=9.9.19','./js/extra-info.js?v=9.9.19',
  './js/agenda.js?v=9.9.19','./js/vakantie.js?v=9.9.19','./js/vakantie-keuze.js?v=9.9.19',
  './js/app.js?v=9.9.19','./js/ui.js?v=9.9.19','./js/backup.js?v=9.9.19',
  './js/clear-local-storage.js?v=9.9.19','./js/mijn-reisdag.js?v=9.9.19',
  './js/vakantie-archief.js?v=9.9.19','./js/restore.js?v=9.9.19','./js/search.js?v=9.9.19',
  './js/help.js?v=9.9.19','./js/offline-prepare.js?v=9.9.19','./config/vakanties.json?v=9.9.19',
  './js/aantekeningen.js?v=9.9.19'
];
