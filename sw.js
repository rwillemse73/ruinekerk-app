/* Reisblik 9.8.15 — tijdelijke offline vakantie */
const CACHE_NAME = 'reisblik-app-v9.8.15';
...
const APP_SHELL = [
  ...
  './js/clear-local-storage.js?v=9.7.5','./js/mijn-reisdag.js?v=9.8.15',
  './js/vakantie-archief.js?v=9.8.15',
