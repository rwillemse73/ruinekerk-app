/* Reisblik 9.9.26 — betrouwbare actuele configuratie + cache-update */
const CACHE_NAME = 'reisblik-app-v9.9.26';
const OFFLINE_PREFIX = 'reisblik-offline-vacation-';
const APP_SHELL = [
  './','./index.html','./app.html','./manifest.json','./logo/icon-192.png','./logo/icon-512.png','./css/reisblik.css?v=9.9.26',
  './js/visited.js?v=9.9.26','./js/navigation.js?v=9.9.26','./js/extra-info.js?v=9.9.26',
  './js/agenda.js?v=9.9.26','./js/vakantie.js?v=9.9.26','./js/vakantie-keuze.js?v=9.9.26',
  './js/app.js?v=9.9.26','./js/ui.js?v=9.9.26','./js/backup.js?v=9.9.26',
  './js/clear-local-storage.js?v=9.9.26','./js/mijn-reisdag.js?v=9.9.26',
  './js/vakantie-archief.js?v=9.9.26','./js/restore.js?v=9.9.26','./js/search.js?v=9.9.26',
  './js/help.js?v=9.9.26','./js/offline-prepare.js?v=9.9.26','./config/vakanties.json?v=9.9.26',
  './js/aantekeningen.js?v=9.9.26','./js/quiz.js?v=9.9.26'
];
