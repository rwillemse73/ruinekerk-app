/* Reisblik 9.9.3 — tijdelijke offline vakantie */
const CACHE_NAME = 'reisblik-app-v9.9.3';
const OFFLINE_PREFIX = 'reisblik-offline-vacation-';
const APP_SHELL = [
  './','./index.html','./manifest.json','./css/reisblik.css?v=9.9.3',
  './js/visited.js','./js/navigation.js','./js/extra-info.js?v=9.7.5',
  './js/agenda.js?v=9.7.5','./js/vakantie.js?v=9.9.3','./js/vakantie-keuze.js?v=9.9.3',
  './js/app.js?v=9.9.3','./js/ui.js?v=9.7.5','./js/backup.js?v=9.8.6',
  './js/clear-local-storage.js?v=9.7.5','./js/mijn-reisdag.js?v=9.9.3',
  './js/vakantie-archief.js?v=9.9.3',
  './js/restore.js?v=9.8.6','./js/search.js?v=9.9.3','./js/help.js?v=9.9.3',
