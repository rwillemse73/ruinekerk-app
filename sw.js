/* Reisblik 9.9.22 — betrouwbare actuele configuratie + cache-update */
const CACHE_NAME = 'reisblik-app-v9.9.22';
const OFFLINE_PREFIX = 'reisblik-offline-vacation-';
const APP_SHELL = [
  './','./index.html','./app.html','./manifest.json','./logo/icon-192.png','./logo/icon-512.png','./css/reisblik.css?v=9.9.22',
  './js/visited.js?v=9.9.22','./js/navigation.js?v=9.9.22','./js/extra-info.js?v=9.9.22',
  './js/agenda.js?v=9.9.22','./js/vakantie.js?v=9.9.22','./js/vakantie-keuze.js?v=9.9.22',
  './js/app.js?v=9.9.22','./js/ui.js?v=9.9.22','./js/backup.js?v=9.9.22',
  './js/clear-local-storage.js?v=9.9.22','./js/mijn-reisdag.js?v=9.9.22',
  './js/vakantie-archief.js?v=9.9.22','./js/restore.js?v=9.9.22','./js/search.js?v=9.9.22',
  './js/help.js?v=9.9.22','./js/offline-prepare.js?v=9.9.22','./config/vakanties.json?v=9.9.22',
  './js/aantekeningen.js?v=9.9.22','./js/quiz.js?v=9.9.22'
];
