/* Reisblik 9.9.17 — tijdelijke offline vakantie */
const CACHE_NAME = 'reisblik-app-v9.9.17';
const OFFLINE_PREFIX = 'reisblik-offline-vacation-';
const APP_SHELL = [
  './','./index.html','./app.html','./manifest.json','./css/reisblik.css?v=9.9.17',
  './js/visited.js','./js/navigation.js','./js/extra-info.js?v=9.7.5',
  './js/agenda.js?v=9.7.5','./js/vakantie.js?v=9.9.17','./js/vakantie-keuze.js?v=9.9.17',
  './js/app.js?v=9.9.17','./js/ui.js?v=9.7.5','./js/backup.js?v=9.8.6',
  './js/clear-local-storage.js?v=9.7.5','./js/mijn-reisdag.js?v=9.9.17',
  './js/vakantie-archief.js?v=9.9.17',
  './js/restore.js?v=9.8.6','./js/search.js?v=9.9.17','./js/help.js?v=9.9.17',
  './js/offline-prepare.js?v=9.8.6','./config/vakanties.json','./js/aantekeningen.js?v=9.8.6'
];
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{
    ...
    // Live configuratie: altijd eerst het actuele vakantiebestand proberen.
    // Zo blijven nieuwe subplaatsen/vakanties niet hangen in een oude telefooncache.
    if(same && url.pathname.endsWith('/config/vakanties.json')){
      try{
    ...
    // Het vakantiearchief is bewust niet service-worker-gecached, zodat nieuwe archiefvakanties direct zichtbaar zijn.
    ...
    try{
      ...
      if(request.mode==='navigate'){const fallback=await caches.match('./index.html','./app.html'); if(fallback)return fallback;}
      throw error;
    }
  })());
});
