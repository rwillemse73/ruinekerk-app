/* Reisblik 9.9.31 — betrouwbare actuele configuratie + cache-update */
const CACHE_NAME = 'reisblik-app-v9.9.31';
const OFFLINE_PREFIX = 'reisblik-offline-vacation-';
const APP_SHELL = [
  './','./index.html','./app.html','./manifest.json','./logo/icon-192.png','./logo/icon-512.png','./css/reisblik.css?v=9.9.31',
  './js/visited.js?v=9.9.31','./js/navigation.js?v=9.9.31','./js/extra-info.js?v=9.9.31',
  './js/agenda.js?v=9.9.31','./js/vakantie.js?v=9.9.31','./js/vakantie-keuze.js?v=9.9.31',
  './js/app.js?v=9.9.31','./js/ui.js?v=9.9.31','./js/backup.js?v=9.9.31',
  './js/clear-local-storage.js?v=9.9.31','./js/mijn-reisdag.js?v=9.9.31',
  './js/vakantie-archief.js?v=9.9.31','./js/restore.js?v=9.9.31','./js/search.js?v=9.9.31',
  './js/help.js?v=9.9.31','./js/offline-prepare.js?v=9.9.31','./config/vakanties.json?v=9.9.31',
  './js/aantekeningen.js?v=9.9.31','./js/quiz.js?v=9.9.31'
];
