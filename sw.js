/* Reisblik 9.9.0 — tijdelijke offline vakantie */
const CACHE_NAME = 'reisblik-app-v9.9.0';
...
const APP_SHELL = [
  ...
  './js/agenda.js?v=9.7.5','./js/vakantie.js?v=9.9.0','./js/vakantie-keuze.js?v=9.9.0',
  './js/app.js?v=9.9.0','./js/ui.js?v=9.7.5','./js/backup.js?v=9.8.6',
  './js/clear-local-storage.js?v=9.7.5','./js/mijn-reisdag.js?v=9.9.0',
  './js/vakantie-archief.js?v=9.9.0',
  './js/restore.js?v=9.8.6','./js/search.js?v=9.9.0','./js/help.js?v=9.9.0',
