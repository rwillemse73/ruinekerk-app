/* Reisblik 9.8.3 — tijdelijke offline vakantie */
const CACHE_NAME = 'reisblik-app-v9.8.3';
...
const APP_SHELL = [
  ...
  './js/clear-local-storage.js?v=9.7.5','./js/mijn-reisdag.js?v=9.8.1',
  './js/restore.js?v=9.7.5','./js/search.js?v=9.7.5','./js/help.js?v=9.7.5',
  './js/offline-prepare.js?v=9.8.2','./config/vakanties.json'
];
